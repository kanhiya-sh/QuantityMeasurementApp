...
public class FeetInchesMeasurement {
    ...
    public static void main(String[] args) {
        ...
        boolean feetRes = checkFeetEquality(1.0, 1.0);
        boolean inchRes = checkInchesEquality(1.0, 1.0);

        System.out.println("Feet Equality: " + feetRes);
        System.out.println("Inches Equality: " + inchRes);
    }
}
